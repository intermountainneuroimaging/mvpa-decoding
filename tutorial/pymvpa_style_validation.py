...
Usage:
    ...
    python tutorial/pymvpa_style_validation.py --our-results-dir out/haxby_object_classifier/1/test
"""
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Path to mvpa_workflow.py's test/ output dir (<analysis-output-dir>/<desc>/<subject>/test) -- "
             "the independent-test-set 'Full' family, since this script's matched split corresponds to "
             "model_conditions.testing -- to print alongside for comparison. Omit to skip that comparison row."
    )
