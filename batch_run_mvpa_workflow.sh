...
# --------------------------------------------
python workflows/mvpa_generalization_workflow.py --subject $subject --config $CONFIG_DIR/vvs_object_classifier.json \
    --master-spreadsheet $MASTER_SPREADSHEET --analysis-output-dir $OUTPUT_DIR

# --------------------------------------------
# gm category classifier
# --------------------------------------------
python workflows/mvpa_generalization_workflow.py --subject $subject --config $CONFIG_DIR/gm_object_classifier.json \
    --master-spreadsheet $MASTER_SPREADSHEET --analysis-output-dir $OUTPUT_DIR

# --------------------------------------------
# gm valence classifier
# --------------------------------------------
python workflows/mvpa_generalization_workflow.py --subject $subject --config $CONFIG_DIR/gm_valence_classifier.json \
    --master-spreadsheet $MASTER_SPREADSHEET --analysis-output-dir $OUTPUT_DIR